...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const renderLogoItem = useCallback(
        ...
        const content = (
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            {showTitle && item.title && (
              <span 
                className={cx(
                  "text-[0.3em] font-medium tracking-[0.2em] uppercase whitespace-nowrap",
                  titleClassName
                )}
              >
                {item.title}
      ...
      [isVertical, scaleOnHover, renderItem, showTitle, titleClassName]
    );
